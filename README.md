...
Before you being, create a new repository within GitHub callled "cookie-stand". Make sure that this repository is propertly set up with a license and a readme. Clone this repo down to your local machine
...
Within the `sales.html` file, create a separate JS object literal (no constructor functions... yet) for each shop location that does the following:
...
- Refer to the setting up a new document  from class 02 to do the intital file/directory configuration of this project.
